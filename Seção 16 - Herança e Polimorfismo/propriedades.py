...
# Foma errada de manipular dados privados:
...
# Refatorando usando getters e setters ao estilo do Python
...
# Criando métodos como propriedades - basta utilizar o decotator Property
    @property 
