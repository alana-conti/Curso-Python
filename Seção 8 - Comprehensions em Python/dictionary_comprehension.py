...
{chave:valor for valor in iterável} - Dictionary Comprehensions
[valor for valor in iterável] - List Comprehensions
...
numeros = [1, 2, 3, 4, 5, 1, 2] # No dicionário não temos repetição de chaves!
