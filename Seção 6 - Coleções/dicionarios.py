...
[0, 1, 2] -> chave (implícita na lista)
[1, 2, 3] -> valor

(0, 1, 2) -> chave (implícita na tupla)
(1, 2, 3) -> valor
...
paises = {'br': 'Brasil', 'eua': 'Estados Unidos da América', 'py': 'Paraguai'}
...
paises = dict(br='Brasil', eua='Estados Unidos da América', py='Paraguai')
...
localidades = {
    ...
    (40.7128, 74.0000): 'Escritório em Nova York',
    (37.7749, 122.41947): 'Escritório em São Paulo',
}
