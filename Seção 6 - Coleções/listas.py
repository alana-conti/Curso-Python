...
Listas em python funcionam como vetores ou matrizes (arrays) em outras linguagens, com a diferença
de serem DINÂMICAS e também de podermos colocar QUALQUER tipo de dado.

Linguagens C/Java: Arrays
    - Possuem tamanho e tipo de dado fixo;
    Ou seja, nestas linguagens se você criar um array do tipo int e com tamnaho 5, este array
...
lista5 = list('Geek University') # ['G', 'e', 'e', 'k', ' ', 'U', 'n', 'i', 'v', 'e', 'r', 's', 'i', 't', 'y']
...
# Para adicional elementos/valores em listas, utilizamos a função append
...
lista1.append([8, 3, 1]) # Adiciona a lista em si [], como elemento único -> sublista
print(lista1)
...
lista1.extend([123, 44, 67]) # Adiciona os valores individualmente na lista. Mas o .extend não aceita um valor único, apenas iteráveis (listas, strings)
print(lista1)
...
# OSB.: Os elementos a direita desse índice serão deslocados para a esquerda
...
# OBS.: Por padrão, o split separa os elementos da lista pelo espaço entre as palavras.
...
print(lista[::]) # Imprime todos os elementos restantes
print(lista[1:]) # Iniciando no índice 1 e pegando todos os elementos restantes
print(lista[-1:]) # Iniciando no índice -1 e pegando todos os elementos restantes
print(lista[-3:]) # Iniciando no índice -3 e pegando todos os elementos restantes
...
print(lista[:-1]) # Começa em 0, pega até o índice -1 - 1
...
# Veja que utilizamos a cópia via atribuição r copiamos os dados da lista para a nova lista, mas
