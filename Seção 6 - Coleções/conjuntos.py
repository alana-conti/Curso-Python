...
cidades = ['Belo Horizonte', 'São Paulo', 'Campo Grande', 'Cuíaba', 'Campo Grande', 'São Paulo', 'Cuíaba']
...
# O que você faria? Faria ul loop na lista...?
...
print(s) # NÃO é índice! Informamos o valor a ser removido.
...
# um contendo estudantes do curso Java
...
# Forma 1 - Utilizando union (recomendado - maior clareza)

unicos1 = estudantes_java.union(estudantes_python)
# {'Patricia', 'Fernando', 'Ellen', 'Gustavo', 'Pedro', 'Ana', 'Guilherme', 'Marcos', 'Julia'}
# unicos1 = estudantes_python.union(estudantes_java)
# {'Guilherme', 'Ellen', 'Pedro', 'Fernando', 'Patricia', 'Julia', 'Marcos', 'Gustavo', 'Ana'}
print(unicos1)
