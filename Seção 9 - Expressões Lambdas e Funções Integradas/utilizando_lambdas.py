...
# Outro exemplo - utilização correta da Lambda
...
# Vamos criar uma Lambda para extrair o sobrenome e ordenar os autores por ele
...
# APLICAÇÃO DE LAMBDAS
- Geralmente para filtragem e ordenação de dados.
"""
