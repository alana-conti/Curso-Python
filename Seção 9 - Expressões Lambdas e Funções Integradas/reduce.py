...
OBS.: A partir do Python3+ a função reduce() não é mais uma função integrada (build-in). Agora temos que
...
Ou seja, a cada passo ela aplica a função passando como primeiro argumento o resultado da aplicação anterior. No final,
...
multi = lambda x, y: x * y # Caso a função tenha apenas 1 parâmetro, o reduce() da TypeErros
