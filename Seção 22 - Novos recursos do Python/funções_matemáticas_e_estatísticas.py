...
# math.isqrt - retorna a parte inteira da raz quadrada de um número. ATENÇÃO! Ele não arredonda os valores.
...
# print(math.hypot(*p3d1)) # O * é obrigatório, pois ele é responsável por descompactar os containers de dados.
...
# statistics.fmean - calcula a média de números reais (f -> float, mean -> média)
